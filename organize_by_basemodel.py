...
def main():
    if len(sys.argv) < 5:
        print("使用方法: python3 organize_by_basemodel.py <base_model_csv> <model_name_csv> <image_source_dir> <output_base_dir>")
        print()
        print("参数说明:")
        ...
        print()
        print("示例:")
        print("  python3 organize_by_basemodel.py merged_new_fetch_images.csv merged_new_fetch_images_v2.csv ./source_images ./organized_images")
        sys.exit(1)
